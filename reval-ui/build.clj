  ...
  [[:licenses
   ...
   [:developers
    [:developer
     [:name "pink-gorilla"]]]
   [:scm
    [:url "https://github.com/pink-gorilla/reval/"]
    [:connection "scm:git:git://github.com/pink-gorilla/reval.git"]
    [:developerConnection "scm:git:ssh://git@github.com/pink-gorilla/reval.git"]]])
